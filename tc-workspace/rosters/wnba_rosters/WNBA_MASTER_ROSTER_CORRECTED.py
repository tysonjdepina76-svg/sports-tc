...
HEIGHT FORMAT: All players use dash format (6-4, 5-8, etc.)
FIXES APPLIED:
  - Removed 12 duplicate entries (kept most recent team assignment)
  - Decoded HTML entities (&#x27; → ')
  - Corrected corrupted name "Sylvia F + 9" → "Sylvia F"
  - Standardized all heights to dash format
"""
...
BENCH_CHI = [
    ...
    # NOTE: Elizabeth Williams moved to LAS — removed duplicate
    # NOTE: NaLyssa Smith moved to LVA — removed duplicate
    # NOTE: Erica Wheeler moved to LAS — removed duplicate
]
...
# NOTE: Tiffany Hayes duplicate removed — she is currently on GS Valkyries
...
# TOR — Toronto Tempo
STARTERS_TOR = [
    Player("Sylvia F","G","5-8",27.0,4.5,3.0,3.0),
...
BENCH_TOR = [
    ...
    Player("Brittany Sykes","G","6-0",5.1,0.9,1.0,0.0),
