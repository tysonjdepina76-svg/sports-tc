...
CONS_3PM    = 0.70
LINE_FACTOR = 0.88
HISTORICAL_GAP = 9.3  # Recalibrated WNBA: was 4.5, raised to 9.3 — TC line now sits ~3pts below market, giving OVER bettors a support cushion
PLAYOFF_MULT   = 1.18
Q_FACTOR   = 0.55
GAP_PTS    = -3.0
GAP_REB    = -1.5
...
class Team:
    ...
    def tc_team_total(self) -> float:
        """Sum of ALL four stat TCs for top-9 active players."""
